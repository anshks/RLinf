...
from rlinf.models.embodiment.openpi.dataconfig.worldgym_dataconfig import (
    LeRobotWorldGymDataConfig,
)
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotLiberoDataConfig(
            ...
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(assets_dir="checkpoints/torch/fold_depth_split/assets"),
            extra_delta_transform=False,
        ),
        batch_size=256,
        lr_schedule=_optimizer.CosineDecaySchedule(
